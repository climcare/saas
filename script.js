...
function atualizarComponenteScore(score) {
    ...
    if (scoreContainer) {
        ...
        scoreContainer.className = `w-14 h-14 sm:w-16 sm:h-16 rounded-full border-4 flex flex-col items-center justify-center shrink-0 transition-all ${corBorda} ${bgScore}`;
    }
}
